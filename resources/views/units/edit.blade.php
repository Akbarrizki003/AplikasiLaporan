        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('units.update', $unit->id_unit) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <select id="id_user" class="form-control @error('id_user') is-invalid @enderror" name="id_user" required>
                                    ...
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}" {{ (old('id_user', $unit->id_user) == $user->id) ? 'selected' : '' }}>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nama_unit" type="text" class="form-control @error('nama_unit') is-invalid @enderror" name="nama_unit" value="{{ old('nama_unit', $unit->nama_unit) }}" required autofocus>
                                @error('nama_unit')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="direktur" type="text" class="form-control @error('direktur') is-invalid @enderror" name="direktur" value="{{ old('direktur', $unit->direktur) }}" required>
                                @error('direktur')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="telepon" type="text" class="form-control @error('telepon') is-invalid @enderror" name="telepon" value="{{ old('telepon', $unit->telepon) }}" required>
                                @error('telepon')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                @if ($unit->logo)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/' . $unit->logo) }}" alt="Logo Unit" width="100">
                                    </div>
                                @endif
